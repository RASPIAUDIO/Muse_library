// museluxe.cpp - Implementation file for ESP Muse Luxe NeoPixel and Battery Management System (BMS) using IP5306
// (c) 2024 RASPiAudio
...
void MuseLuxe::begin() {
    ...
    // Initialize I2C for IP5306 communication
...
uint8_t MuseLuxe::getBatteryLevel() {
    ...
    if (Wire.endTransmission(false) == 0 && Wire.requestFrom(IP5306_I2C_ADDRESS, 1)) {
